...
if __name__ == "__main__":
    ...
    tokenizer = BartTokenizer.from_pretrained('/home/students/he/Pretraining_AMR/bart_model_subgraph',local_files_only=True) # load the bart model
    model = BartForConditionalGeneration.from_pretrained('/home/students/he/Pretraining_AMR/bart_model_subgraph',local_files_only=True)
