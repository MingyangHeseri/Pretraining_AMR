...
if __name__ == "__main__":
    ...
    new_amr_list_masked = masking_amr(sentence_test, masking_rate=0.15)
    ...
    dataset_test = to_dataset(inpus_sequnce=amr_sequences_test, labels_sequence=new_amr_list_masked,tokenizer=tokenizer,
                         device=device)
