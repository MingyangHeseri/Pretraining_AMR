...
if __name__ == "__main__":
    ...
    tokenizer = BartTokenizer.from_pretrained('/home/students/he/Pretraining_AMR/bart_model_g2t',local_files_only=True)
    model = BartForConditionalGeneration.from_pretrained('/home/students/he/Pretraining_AMR/bart_model_g2t',local_files_only=True)
